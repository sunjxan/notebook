...
3. 新建容量为260MB的EFI分区和50GB以上的系统分区；
...
12. 从 https://github.com/googlehosts/hosts/blob/master/hosts-files/hosts 中复制解析规则到 `C:\Windows\System32\drivers\etc\hosts` 文件中；
13. 在“设置 -> 更新和安全 -> 备份”中，恢复已备份文件；
