...
```
# 启动
sudo python3 /usr/local/shadowsocksr/shadowsocks/local.py -d start
# 停止
sudo python3 /usr/local/shadowsocksr/shadowsocks/local.py -d stop
# 重启
sudo python3 /usr/local/shadowsocksr/shadowsocks/local.py -d restart
```
